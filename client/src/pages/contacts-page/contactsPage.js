            ...
            <div className="content">
                    ...
                    <div className="location">
                        ...
                        <div className="location_icons">
                            <div className="item">
                                <a href="#" className="icon"><img src={location} alt="instagram"/></a>
                                <a href="https://goo.gl/maps/mVfvmr4Afwex3FC49" className="text">Вул. Машинобудівна 41</a>
                            </div>
                            <div className="item">
                                <a href="#" className="icon"><img src={phone} alt="telegram"/></a>
                                <a href="tel:380508087584" className="text">+38 050 808 75 84</a>
                            </div>
                            <div className="item">
                                <a href="#" className="icon"><img src={email} alt="telegram"/></a>
